        ...
        report.write_text(
            "\n".join(
                [
                    ...
                    "- `scripts/harnessctl.py`: thin local validation, event, report, visualization-spec, eval-run, viz-export, archive, context-pack, worker-brief, model-route, task-packet, and software-feedback command surface",
