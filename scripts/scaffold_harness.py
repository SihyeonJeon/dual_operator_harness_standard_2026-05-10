    ...
    target.joinpath("harness", "shared", "ACTIVE_SNAPSHOT.md").write_text(
        "\n".join(
            [
                ...
                "- Broadcast, reviewer, and MCP export surfaces are scaffolded but `UNVERIFIED`; external publication is denied until approved.",
                "- Internal canonical records and external channel records must remain separated.",
                ...
                "- Confirm whether broadcast drafts, external evidence outputs, external reviewers, or MCP context export are required before activating them.",
    ...
    target.joinpath("progress.md").write_text(
        "\n".join(
            [
                ...
                "- Broadcast draft queue, reviewer adapters, MCP export, and spec automation scaffolds created.",
                ...
                "- External-channel records remain separate until summarized into canonical files.",
                "",
                "## Decisions",
                "",
        ...
        report.write_text(
            "\n".join(
                [
                    ...
                    "- `scripts/harnessctl.py`: thin local validation, event, report, visualization-spec, eval-run, broadcast-draft, review-packet, and archive command surface",
                    ...
                    "- `harness/shared/CHANNEL_RECORDS.md`: internal canonical vs external channel record boundary",
                    "- `harness/shared/CONTEXT_PRESSURE.md`: context budget, compaction, and context pack rules",
                    "- `harness/broadcast/`: draft-only external signal and external evidence queue",
                    "- `harness/reviewers/`: external reviewer packet and ledger scaffold",
                    ...
                    "- Confirm visualization spec before creating dashboards, timelines, graphs, live status UI, or external evidence views.",
                    "- Confirm broadcast/reviewer/MCP export activation before using external channels; drafts are not publication and reviewer output is not authority.",
    ...
    guide.write_text(
        "\n".join(
            [
                ...
                "- Confirm broadcast draft, external reviewer, and MCP export needs before activating external interfaces.",
                "- Confirm project-specific start, test, build, and evaluation commands.",
                ...
                "- Do not publish broadcast drafts or send external review packets containing private data without approval and redaction.",
