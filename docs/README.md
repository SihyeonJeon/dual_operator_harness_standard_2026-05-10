...
| [Evaluation framework comparison 2026-05-24](EVAL_FRAMEWORK_COMPARISON_2026-05-24.md) | background comparison notes |
| [Public example report 2026-05-24](PUBLIC_DEMO_REPORT_2026-05-24.md) | historical example report |
| [Benchmark workplan 2026-05-26](BENCHMARK_WORKPLAN_2026-05-26.md) | backlog and benchmark expansion notes |
