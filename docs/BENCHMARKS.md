...
| --- | --- | --- | --- |
| requirements traceability | `python3 benchmarks/requirements_traceability/score.py --check-summary` | 174/174 checks | scaffold coverage, not live model quality |
...
| software feedback and communication | `python3 scripts/validate_kit.py` | generated validator checks model aliases, agent communication, and software feedback policy | policy surface, not live browser quality benchmark |
