...
- Verify part ownership and no-touch boundaries.
- Run or verify debugging closure before operator submission.
- Run cross-evaluation when required.
- Recommend regulation updates when failures repeat.
