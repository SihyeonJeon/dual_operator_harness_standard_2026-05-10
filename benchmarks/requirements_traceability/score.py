...
CATEGORIES: tuple[Category, ...] = (
    ...
    Category(
        ...
        text=(
            TextCheck("harness/shared/QUALITY_GATES.md", ("evidence", "NOT-RUN", "Current Research Gate", "Cross Feedback Gate")),
            TextCheck("harness/shared/CROSS_FEEDBACK_LOOP.md", ("independent feedback path", "Material dissent is preserved", "harnessctl.py cross-feedback")),
            ...
            TextCheck("scripts/harnessctl.py", ("current-research", "CURRENT_RESEARCH.json", "cross-feedback", "CROSS_FEEDBACK.json", "software-feedback", "SOFTWARE_FEEDBACK.json", "concept-check", "CONCEPT_CHECK.json")),
