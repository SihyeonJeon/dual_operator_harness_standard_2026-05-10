...
CATEGORIES: tuple[Category, ...] = (
    ...
    Category(
        ...
        text=(
            ...
            TextCheck("scripts/harnessctl.py", ("worker-brief", "WORKER_BRIEF.json")),
        ),
    ),
    Category(
    ...
    Category(
        ...
        text=(
            ...
            TextCheck("harness/shared/CURRENT_MARKET_RESEARCH_POLICY.md", ("Before the operator approves an overall plan", "as-of the command date", "CURRENT_RESEARCH.json")),
            TextCheck("harness/tasks/F0-PLANNING-RUNWAY/BLUEPRINT.md", ("current-state market/comparable research", "before production")),
        ),
    ),
    Category(
        ...
        text=(
            TextCheck("harness/shared/QUALITY_GATES.md", ("evidence", "NOT-RUN", "Current Research Gate", "Cross Feedback Gate", "Benchmark Claim Gate", "harnessctl.py preregister-benchmark", "harnessctl.py blind-redact", "RECOVERY_EVIDENCE_PACKET.json")),
            TextCheck("harness/shared/CROSS_FEEDBACK_LOOP.md", ("independent feedback path", "Material dissent is preserved", "harnessctl.py cross-feedback", "harnessctl.py council-decision")),
            ...
            TextCheck("scripts/harnessctl.py", ("current-research", "CURRENT_RESEARCH.json", "cross-feedback", "CROSS_FEEDBACK.json", "software-feedback", "SOFTWARE_FEEDBACK.json", "concept-check", "CONCEPT_CHECK.json", "preregister-benchmark", "blind-redact", "council-decision", "recovery-evidence")),
